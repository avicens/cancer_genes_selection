...
* Identify episodes of positive seleciton on cancer genes across mamalian species.

#Species
For this study, we will compare 32 mammalian species with well annotated genomes. Information about the species see the table:
...
```{r gene_classifications, eval=F, fig.align='center', dpi=100, fig.width=8, fig.height=6,fig.cap="Figure 1. Venn Diagram representing the classification of genes according to their involvement in cancer (left) and tumor type (right)"}
...
To organize the data per gene, I create a working folder for each gene with the *crete_gene_folders.sh* script.
